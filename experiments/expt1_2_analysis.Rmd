...
expt1_might_pred <- read_csv("../model_code/results/might_expt1_2_results.csv") %>%
  ...
  rbind(mutate(read_csv("../model_code/results/trace_expt1_2_results.csv"), expt = "Trace")) %>%
  rbind(mutate(read_csv("../model_code/results/trace_11_expt1_2_results.csv"), expt = "Trace\n(larger memory)")) %>%
...
expt1_model_plot <- ggplot(data = filter(expt1_model_pred#, expt != "Trace"
...
expt1_2_results <- expt1_aggr_test_selections %>%
  ...
  write_csv("../model_comparison/expt1.csv")
...
expt1_2_paper_plot
ggsave("expt1_test_diss.png", width=8, height=6, units="in", dpi="print")
```
